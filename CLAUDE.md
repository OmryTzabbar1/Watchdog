...
5. **Feature PRDs** — Each feature has its own PRD document. Features map to one or more modules:
   ...
   | Feature | PRD | Modules |
   |---------|-----|---------|
   | Heartbeat Monitoring | `docs/prd-heartbeat-monitoring.md` | `heartbeat/`, `monitor/` |
   | Recovery Pipeline | `docs/prd-recovery-pipeline.md` | `pipeline/`, `recovery/` |
   | CLI Commands | `docs/prd-cli-commands.md` | `cli/` |
